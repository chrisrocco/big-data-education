...
<body class="nav-md">
	<div class="container body">
		<div class="main_container">
			...
			<!-- page content -->
			<div class="right_col" role="main" ng-app="paper-coder" ng-controller="ResolutionUtility">
				...
				<div class="row">
					<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
          				<bd-panel title="'Controls'">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-success"
									role="progressbar" aria-valuenow="{{calculateCompletion(experiment)}}"
									aria-valuemin="0" aria-valuemax="100"
									style="width: {{calculateCompletion(experiment)}}%">
									{{calculateCompletion(experiment)}}%</div>
							</div>
          			...
          			<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
          				<bd-panel title="'You are previewing another students paper'">
          					<p>Fill out the forms to the best of your ability, and mark as
								complete!</p>
								
							<!-- New Study Arm Button -->
							<a disabled class="btn btn-app" ng-click="newStudyArm()"> <span
								class="badge bg-red" ng-cloak>{{otherPaper.studyArms.length}}</span>
								<i class="fa fa-plus"></i> New Arm
							</a>
          				</bd-panel>
          			</div>
          			...
          			<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
          				<div class="x_panel">
							...
							<div class="x_content">
								...
								<div class="container">
									<!-- domain buttons -->
									<bd-domain ng-repeat="domain in otherPaper.domains"
												domain="domain"
						...
						<div class="x_panel">
							...
							<div class="x_content">
								<!-- Study Arms -->
								<div ng-repeat="arm in otherPaper.studyArms"
									 class="domainButton col-md-2">
									<a ng-click="studyArmClicked(arm)" href=""
										class="snip1489 studyArmButton"
										ng-class="{'done': isComplete(arm)}"> <i class="fa fa-sitemap"
...
<script src="app/paperCoder/resolution.controller.js"></script>
